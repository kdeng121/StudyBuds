...
def search(request):
    ...
    if query and request.method == 'GET':
        return render(request, 'studygroups/index.html', {'events': Event.objects.filter(info__icontains=query)})
    else:
        return render(request, 'studygroups/index.html', {'events': Event.objects.all()})
...
def searchStudent(request):
    ...
    if query and request.method == 'GET':
        return render(request, 'studygroups/index.html', {'events': Event.objects.filter(name__icontains=query)})
    else:
        return render(request, 'studygroups/index.html', {'events': Event.objects.all()})
